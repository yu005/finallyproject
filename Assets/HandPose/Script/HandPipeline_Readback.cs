...
sealed partial class HandPipeline
{
    ...
    Vector4[] _readCache = new Vector4[KeyPointCount * MaxHandCount];
    bool _readFlag;
    ...
    {
        _buffer.filter.GetData(_readCache, 0, 0, KeyPointCount * MaxHandCount);
        _readFlag = true;
        return _readCache;
    }
    ...
    const int ReadbackBytes = KeyPointCount * MaxHandCount * sizeof(float) * 4;
